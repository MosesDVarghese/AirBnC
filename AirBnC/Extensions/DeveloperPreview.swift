...
class DeveloperPreview {
    ...
    var listings: [Listing] = [
        ...
        .init(
            ...
            city: "Miami",
            state:"Florida",
            title:"Beautiful Miami Apartment in downtown Brickwall",
            rating: 4.32,
            features: [.selfCheckIn, .superHost],
        ...
        .init(
            ...
            latitude: 34.1,
            longitude: -118.1426,
            imageURLs: ["listing-6", "listing-4", "listing-3", "listing-1"],
            address: "124 Main St",
            city: "Miami",
            state:"Florida",
